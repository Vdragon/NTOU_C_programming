...
int main(void)
	...
	//
		int num;
	//－－－－－－－－－－－－－－－－－－－－－
		printf("Input in 十進位(decimal)：");
		scanfTriggered = 1;
		scanf("%d", &num);
		printf("Output in 十進位(decimal)：%d\n", num);

		printf("Input in 八進位(octal)：");
		scanfTriggered = 1;
		scanf("%o", &num);
		printf("Output in 十進位(decimal)：%d\n", num);

		printf("Input in 十六進位(hexidecimal)：");
		scanfTriggered = 1;
		scanf("%x", &num);
		printf("Output in 十進位(decimal)：%d", num);
	//pauseProgram
		if(pauseProgram())
			{
				goto restartProgram;
