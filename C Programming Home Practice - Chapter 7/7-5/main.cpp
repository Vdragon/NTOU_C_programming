//程式框架(Program Frame)
//-------------------------------------------------------------------
//程式名稱(Program Name)：7-5。
//程式敘述(Program Description)：Define a single-precision floating point variable numf.Ask the user to key in a real number, multiple it with 3, and then print the value out in brackets. 。
//程式版本(Program Version)：1.00(0)
//程式框架版本(Program Frame Version)：A
//程式框架修訂號(Program Frame Revision Number)：23
//最新更新紀錄(Latest Update Log)：。
/*更新紀錄(Change Log)：build ok。
1.00(0)　開始實作
*///更新紀錄(Change Log)：。
//--------------注意事項--------------
/*
...
void printTitle()
    {
          printf("程式名稱(Program Name)：7-5。\n");
          printf("程式敘述(Program Description)：\nDefine a single-precision floating point variable numf.Ask the user to key in a real number, multiple it with 3, and then print the value out in brackets. 。\n");
