...
int main(void)
    ...
    //counter for//for loop from a to z
        short int countLp1;
        char alph, alphCAP;
	//－－－－－－－－－－－－－－－－－－－－－
    //printTitle
        //printTitle();
                                                                                                                //find ASCII code for a = 97 & A = 65
                                                                                                                    //printf("%d\t%d\n", 'a', 'A');
    //for loop from a to z
    //switch
        for(countLp1 = 0, alphCAP = 65, alph = 97; countLp1 < 26; countLp1++, alphCAP++, alph++)
            {
                //print
                    printf("英文字母第 %d 個字，大寫是 [%c]，小寫是 [%c]。\n", countLp1 + 1, alphCAP, alph);
            }
    //
	//pause
		pauseProgram();
