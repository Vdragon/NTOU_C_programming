//程式框架(Program Frame)
//-------------------------------------------------------------------
//程式名稱(Program Name)：C Programming Home Practice - Chapter 5, if...else and switch statements-1。
//程式敘述(Program Description)：Input an integer n. If it is a multiple of 7, print out the message "七的倍數！我的幸運數字！(Its a multiple of 7, my lucky number!)"。
...
//標題
//版本：1.00(1)
printf("程式名稱(Program Name)：C Programming Home Practice - Chapter 5, if...else and switch statements-1。\n");
