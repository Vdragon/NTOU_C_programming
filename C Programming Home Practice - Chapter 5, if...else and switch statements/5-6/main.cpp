//程式框架(Program Frame)
//-------------------------------------------------------------------
//程式名稱(Program Name)：C Programming Home Practice - Chapter 5, if...else and switch statements-6。
//程式敘述(Program Description)：(Following Problem 3) Input an integer n. Check if it is a multiple of 5 or 7. If not, print the message "什麼都不是。(Nothing!)" 。
...
//標題
//版本：1.00(1)
printf("程式名稱(Program Name)：C Programming Home Practice - Chapter 5, if...else and switch statements-6。\n");
printf("程式敘述(Program Description)：\n(Following Problem 3) Input an integer n. Check if it is a multiple of 5 or 7. If not, print the message \"什麼都不是。(Nothing!)\" \n");
