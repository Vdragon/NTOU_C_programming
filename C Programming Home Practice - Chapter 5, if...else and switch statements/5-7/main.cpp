//程式框架(Program Frame)
//-------------------------------------------------------------------
//程式名稱(Program Name)：C Programming Home Practice - Chapter 5, if...else and switch statements-7。
//程式敘述(Program Description)：Input an integer n. First, check if it is a multiple of 7. If not, check if it is a multiple of 5.  。
...
//標題
//版本：1.00(1)
printf("程式名稱(Program Name)：C Programming Home Practice - Chapter 5, if...else and switch statements-7。\n");
printf("程式敘述(Program Description)：\nInput an integer n. First, check if it is a multiple of 7. If not, check if it is a multiple of 5. \n");
