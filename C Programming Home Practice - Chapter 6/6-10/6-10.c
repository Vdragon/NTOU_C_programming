//程式框架(Program Frame)
//-------------------------------------------------------------------
//程式名稱(Program Name)：C Programming Home Practice - Chapter 6-10。
//程式敘述(Program Description)：Calculate the sum of this series: 1+4+16+...+16384 (Hint: a geometric series with a common ratio of 4). The answer should be 21845. 。
...
//標題
//版本：1.00(3)
      printf("程式名稱(Program Name)：C Programming Home Practice - Chapter 6-10。\n");
