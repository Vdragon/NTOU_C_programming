//程式框架(Program Frame)
//-------------------------------------------------------------------
//程式名稱(Program Name)：C Programming Home Practice - Chapter 6-1。
//程式敘述(Program Description)：Print out odd numbers between 1 and 10.。
...
//標題
//版本：1.00(1)
printf("程式名稱(Program Name)：。C Programming Home Practice - Chapter 6-1\n");
